...
class Stage2_Dataset(Dataset):
    def __init__(self, args, base_dir, split):
        ...
        if self.split   == "train":
            ...
            self._cat_dir       = os.path.join(self._base_dir, 'train_PM/PM_res38d_refinedbn7/')
            self._cat_dir_a     = os.path.join(self._base_dir, 'train_PM/PM_res38d_refinedb5_2')
            self._cat_dir_b     = os.path.join(self._base_dir, 'train_PM/PM_res38d_refinedb4_5')
        elif self.split == 'val':
