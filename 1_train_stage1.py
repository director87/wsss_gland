...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", default='res38d', type=str)
    parser.add_argument("--n_class", default=2, type=int)
    parser.add_argument("--weights", default='init_weights/ilsvrc-cls_rna-a1_cls1000_ep-0001.params', type=str)
    parser.add_argument("--trainroot", default='datasets/RINGS/train/', type=str)
    parser.add_argument("--testroot", default='datasets/RINGS/test/', type=str)
